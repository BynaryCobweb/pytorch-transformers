...
class BERTDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        tokens_b = None if t2 is None else self.tokenizer.tokenize(t2)
...
def accuracy(out, labels):
    ...
    labels = labels.index_select(1, indices).squeeze(0)
    outputs = torch.argmax(out, 2).index_select(1, indices).squeeze(0)
